...
gst_str = "nvcompositor name=mix background-w=1280 background-h=180 \
    ...
    sink_1::xpos=640  sink_1::ypos=0   sink_1::width=320 sink_2::height=180 \
    sink_0::xpos=960 sink_0::ypos=0   sink_0::width=320 sink_3::height=180 \
    ! video/x-raw(memory:NVMM),format=RGBA, width=1280,height=180 ! nvvidconv flip_method=0 ! video/x-raw(memory:NVMM),format=I420 ! nvv4l2h264enc insert-vui=1 insert-sps-pps=1 ! h264parse ! rtph264pay ! udpsink host=192.168.1.1 port=5000  \
